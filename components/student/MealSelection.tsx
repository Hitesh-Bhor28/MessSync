...
export default function MealSelection() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      alert(err.message || "Failed to save meal selection");
    }
  };
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 px-4 py-3 rounded-lg border-2 font-medium transition-all ${selectedDate === 'tomorrow'
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className={`p-6 rounded-xl border-2 cursor-pointer transition-all hover:shadow-md ${meals.breakfast
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <div className={`px-4 py-2 rounded-lg font-medium ${meals.breakfast
                    ? 'bg-green-600 text-white'
                    : 'bg-gray-200 text-gray-600'
                  }`}>
                  {meals.breakfast ? 'Yes' : 'No'}
                </div>
                <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center ${meals.breakfast
          ...
          <div
            ...
            className={`p-6 rounded-xl border-2 cursor-pointer transition-all hover:shadow-md ${meals.lunch
                ? 'border-green-500 bg-green-50'
                : 'border-gray-300 bg-white hover:border-gray-400'
              }`}
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <div className={`px-4 py-2 rounded-lg font-medium ${meals.lunch
                    ? 'bg-green-600 text-white'
                    : 'bg-gray-200 text-gray-600'
                  }`}>
                  {meals.lunch ? 'Yes' : 'No'}
                </div>
                <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center ${meals.lunch
                    ? 'border-green-600 bg-green-600'
                    : 'border-gray-300 bg-white'
                  }`}>
          ...
          <div
            ...
            className={`p-6 rounded-xl border-2 cursor-pointer transition-all hover:shadow-md ${meals.dinner
                ? 'border-green-500 bg-green-50'
                : 'border-gray-300 bg-white hover:border-gray-400'
              }`}
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <div className={`px-4 py-2 rounded-lg font-medium ${meals.dinner
                    ? 'bg-green-600 text-white'
                    : 'bg-gray-200 text-gray-600'
                  }`}>
                  {meals.dinner ? 'Yes' : 'No'}
                </div>
                <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center ${meals.dinner
                    ? 'border-green-600 bg-green-600'
                    : 'border-gray-300 bg-white'
                  }`}>
